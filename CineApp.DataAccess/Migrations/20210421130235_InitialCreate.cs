        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoteAvarage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MovieType = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    ModifiedByUserId = table.Column<int>(type: "int", nullable: true),
                    CreatedDateByUser = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedDateByUser = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisionMovies_Chats_ChatId",
                        column: x => x.ChatId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvailabilityUsers_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityUsers_UserId",
                table: "AvailabilityUsers",
                column: "UserId");
